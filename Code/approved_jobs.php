...
<body>
		<div id="sidebar" onclick="togglemenu()">
			...
			<ul style="list-style-type: none; ">
				...
				<li><a href="offered_applicants.php">OFFERED APPLICANTS</li>
...
<center><br><h1><b>APPROVED JOB APPLICANT PROFILES</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<tr>
					...
					<th><a href="details_student_com.php?c_id=<?php echo $row_Std['email']; ?>&enroll_no=<?php echo $row_Std['enroll_no']; ?>"><input style="width:100px;" type="button" name="details" value="DETAILS"></a></th>
					<th><a href="offer_job_confirm.php?enroll_no=<?php echo $row_Std['enroll_no']; ?>&jid=<?php echo $row['job_id']; ?>"><input style="width:100px;" type="button" name="approval" value="OFFER JOB"></a></th>
					<th><a href="reject_job_offer_confirm.php?enroll_no=<?php echo $row_Std['enroll_no']; ?>&jid=<?php echo $row['job_id']; ?>"><input style="width:100px;" type="button" name="delete" value="REJECT"></a></th>
				</tr>
			...
			<a href="student_jobs_report.php"><button style="margin-left:80% " value="PRINT">Generate REPORT</button></a>
