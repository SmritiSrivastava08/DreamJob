...
<center><br><h1><b>PENDING COLLEGE PROFILES</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<?php
					...
					$sql="SELECT * FROM college where `approval_status`='P';";
				...
				<tr>
					...
					<th><a href="colleges_approval.php?email=<?php echo $row['email']; ?>"><input type="button" name="approval" value="APPROVE"></a></th>
					<th><a href="reject_colleges.php?email=<?php echo $row['email']; ?>"><input type="button" name="delete" value="REJECT"></a></th>
				</tr>
				<?php } ?>
				<tr>
