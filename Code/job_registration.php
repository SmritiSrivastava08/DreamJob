...
<body>
	<div id="sidebar" onclick="togglemenu()">
		...
		<form method="get" action="Home_search.php">
			...
			<label for="age"><b>Age:</b><h5>*</h5></label>
			...
			<label for="graduation_r"><b>Graduation Result:</b><h5>*</h5></label>
			...
			<label for="post_graduation_r"><b>Post Graduation Result:</b><h5>*</h5></label>
