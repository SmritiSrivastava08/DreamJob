...
<body>
		<div id="sidebar" onclick="togglemenu()">
			...
			<ul style="list-style-type: none; font-size:10px;">
				...
				<li><a href="update1_madmin?c_id=<?php echo $_SESSION['email']; ?>">MANAGE ACCOUNT</a></li>
...
<center><br><h1><b>APPROVED COMPANY PROFILES</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<tr>
					...
					<th><a href="details_company.php?id=<?php echo $row['c_id']; ?>"><input type="button" name="details" value="DETAILS"></a></th>
					<th><a href="delete_Company.php?id=<?php echo $row['c_id']; ?>"><input type="button" name="delete" value="DELETE"></a></th>
				</tr>
				<?php } ?>
				<tr>
