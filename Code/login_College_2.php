...
<body>
		...
		<?php
					...
					$sql="SELECT `college_name` FROM college where `email`='$email';";
		...
		<p>Check out the new student profile requests!!!</p>
		<a href="pending_students.php"><button>APPROVE NOW!</button></a>
		</div>
		<footer>
