<?php
	if($_POST['otp1']!=$_POST['otp2'])
	{
		...
		header("refresh:1;url=forgot_pswd_student.php");
	}
?>
<html>
	<head>
	...
	<body>
		...
		<form method="post" action="change_pswd2_student.php" style="margin-left: 20%;width: 400px;">
			...
			<input class="btn btn-primary" style="width: 200px;" type="submit" id="register" name="Submit" value="Submit">
				...
				<a href="login.html" style="margin-left: 20%">LOGIN</a></center>
