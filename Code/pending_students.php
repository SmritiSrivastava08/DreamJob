...
<link rel="javascript" type="text/js" href="print.js">
...
<center><br><h1><b>PENDING STUDENT PROFILES</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<?php
					...
					$sql="SELECT * FROM student where `approval_status`='P' && `u_id` in (select `u_id` from college where `email`='$email');";
				...
				<tr>
					...
					<th><a href="students_approval.php?email=<?php echo $row['email']; ?>"><input type="button" name="approval" value="APPROVE"></a></th>
					<th><a href="reject_students.php?email=<?php echo $row['email']; ?>"><input type="button" name="delete" value="REJECT"></a></th>
				</tr>
				<?php } ?>
				<tr>
