...
<center><br><h1><b>PENDING JOB REQUESTS OF STUDENTS</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<tr>
					...
					<th><a href="details_student_com.php?email=<?php echo $row_Std['email']; ?>"><input style="width:100px;" type="button" name="details" value="DETAILS"></a></th>
					...
					<th><a href="reject_student_jobs.php?enroll_no=<?php echo $row_Std['enroll_no']; ?>&jid=<?php echo $jid; ?>"><input style="width:100px;" type="button" name="delete" value="REJECT"></a></th>
				</tr>
