...
<body>
		...
		<p>Add new Job vacancy, available for Students!!!</p>
		<a href="job_registration.php"><button>ADD NEW JOB!</button></a><br/><br/><br/><br/>
		<p>Check out new Job Applicant's profiles!!!</p>
		<a href="pending_jobs.php"><button>CHECK OUT NOW!</button></a>
		</div>
		<footer>
