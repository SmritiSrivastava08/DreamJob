...
require "PHPMailerAutoload.php";
	//	print_r($_SESSION);
		...
		//echo $p['user_id'];
				...
				$body="<center><b>Your profile has been Rejected!</b></center>
						<p>Please look at your profile for correction and try again</p><br/><br/>
						<p>For any Query please contact us.</p><br/><br/>Thank you for  joining us!<br/><b>-Team DreamJob</b>";							
				$mail = new PHPMailer();
				//$mail->SMTPDebug = 3;
