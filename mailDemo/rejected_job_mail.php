	...
	//	print_r($_SESSION);
		...
		//echo $p['user_id'];
				...
				$company_name=$row_com['company_name'];
					...
					$email=$row['email'];
				$subject='SORRY USER!!!';
				$body="<center><b>Your Job Application has been Rejected!</b></center>
						<p><b>Dear Job Applicant</b>,<br/>We regret to let you know that,Your Job Application for <b>$post in Company $company_name</b> has been Rejected by the Company Recruiter!<br/> Kindly, Verify the Job Application , you submitted.<br/>You may reapply for the Job OR Check out new Available jobs now!<br/></p><br/>Stay in touch!</p><br/><br/><b>ALL THE BEST!</b></center><br/><br/>Thank you for  joining us!<br/><b>-Team DreamJob</b>";							
				$mail = new PHPMailer();
				//$mail->SMTPDebug = 3;
				...
				if(!$mail->send()) {
				   ...
				   echo '<script type="text/javascript">
						alert("You rejected the Applicant\'s Job Request!");
				</script>';
